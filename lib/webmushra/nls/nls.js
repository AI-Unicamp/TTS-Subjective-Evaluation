...
// Buttons
nls['en']['nextButton'] = "Próximo";
nls['en']['previousButton'] = "Anterior"; 
nls['en']['playButton'] = "Play";
nls['en']['stopButton'] = "Stop"; 
nls['en']['pauseButton'] = "Pause";
nls['en']['sendButton'] = "Enviar Resultados";
...
nls['en']['excellent'] = "Completamente Natural";
nls['en']['good'] = "Um Pouco Natural"; 
nls['en']['fair'] = "Nem Natural nem Artificial";
nls['en']['poor'] = "Um Pouco Artificial"; 
nls['en']['bad'] = "Completamente Artificial";
nls['en']['reference'] = "Referência";
nls['en']['cond'] = "Áudio ";
nls['en']['35'] = "Anchor35";
nls['en']['75'] = "Anchor75";
...
nls['en']['quest'] = "Qual áudio tem o estilo mais próximo da referência?";
nls['de']['quest'] = "Welches Stück ist die Referenz?";
nls['fr']['quest'] = "Quel item est la référence?";

// captions finishPage
nls['en']['results'] = "Seus Resultados:";
nls['de']['results'] = "Die Ergebnisse:";
nls['fr']['results'] = "Vos résultats:";
nls['en']['attending'] = "Obrigado pela sua participação!";
