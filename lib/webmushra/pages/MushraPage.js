...
MushraPage.prototype.render = function (_parent) {
  ...
  var tdLoop1 = $(" \
    <td class='stopButton'> \
      <button data-role='cbutton' data-inline='true' id='buttonStop' onclick='"+ this.pageManager.getPageVariableName(this) + ".mushraAudioControl.stop();'>" + this.pageManager.getLocalizer().getFragment(this.language, 'stopButton') + "</button> \
    </td> \
  ");
