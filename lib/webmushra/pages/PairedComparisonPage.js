...
function PairedComparisonPage(_reference, _condition, _pageManager, _pageTemplateRenderer, _audioContext, _bufferSize, _audioFileLoader, _session, _pageConfig, _errorHandler, _language) {
  ...
  for (var i = 0; i < this.condition.length; ++i) {
    this.audioFileLoader.addFile(this.condition[i].getFilepath(), (function (_buffer, _stimulus) { _stimulus.setAudioBuffer(_buffer); }), this.condition[i]);
  }
...
PairedComparisonPage.prototype.init = function () {
  ...
  this.mushraAudioControl = new MushraAudioControl(this.audioContext, this.bufferSize, this.reference, this.condition, this.errorHandler, false, false, false);
...
PairedComparisonPage.prototype.store = function () {
  ...
  choice.nonReference = this.condition[0].getId();
